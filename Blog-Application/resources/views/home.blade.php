                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 offset-md-1 py-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="{{ route('mobiles') }}" class="text-white">Mobiles</a></li>
                            <li><a href="{{ route('post-show') }}" class="text-white">Posts</a></li>
                            <li><a href="{{ route('electronics') }}" class="text-white">Electronic</a></li>
                            <li><a href="{{ route('cars') }}" class="text-white">Cars</a></li>
                    ...
                    @foreach ($posts as $item)
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="{{ asset('posts/' . $item->post) }}" class="card-img-top" alt="...">
                                <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="comments-container" style="max-height: 300px; overflow-y: auto;">
                                                    ...
                                                    <div class="media mb-4 d-flex align-items-center comment-line">
                                                        <img src="/pizza.jpeg" class="rounded-circle mr-3" alt="User Avatar">
                                                        <div>
                                                            <h6 class="mt-0 d-inline">{{ $comment->user->name }}:</h6>
                                                            <p class="d-inline mb-0">{{ $comment->comment }}</p>
                                                            {{-- <small class="text-muted d-inline">({{ $comment->created_at }})</small> --}}
                                                        </div>
                                                    </div>
                                                    @endforeach
    ...
    <footer class="text-body-secondary py-5">
        <div class="container">
            ...
            <p class="mb-0">New to Bootstrap? <a href="/">Visit the homepage</a> or read our <a
                    href="https://getbootstrap.com/docs/5.3/getting-started/introduction/">getting started guide</a>.
            </p>
        </div>
    </footer>
